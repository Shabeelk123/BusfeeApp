...
// ─── Screen ───────────────────────────────────────────────────────────────────
// Replaces the hamburger drawer for Admin — everything that used to live in
// AppDrawer (Manage Grades, Account Management, About, Privacy, Sign Out)
// is now one tab, so Admin's whole app is reachable through the tab bar
// alone instead of mixing tabs with a separate drawer gesture.
    ...
    const items: MenuItem[] = [
        {
            ...
            icon: "layers-outline",
            label: "Manage Grades",
            sublabel: "View, edit and delete grades",
        ...
        },
        {
            ...
            sublabel: "Class & coordinator logins",
