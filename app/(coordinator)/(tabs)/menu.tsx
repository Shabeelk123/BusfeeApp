...
// ─── Theme (Stitch: "Academic Transit Logistics" — matches the Admin/Class Menu) ─
const T = {
    background: "#f7fafc",
    navy: "#1a2b48",
    navyLight: "#e8ebf2",
...
// ─── Screen ───────────────────────────────────────────────────────────────────
// Replaces the hamburger drawer for the Coordinator account — same "Menu"
// tab pattern as Admin/Class (see app/(admin)/(tabs)/menu.tsx and
// app/(class)/(tabs)/menu.tsx).
export default function CoordinatorMenuScreen() {
